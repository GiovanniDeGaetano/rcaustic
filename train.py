...
parser.add_argument(
    "-c",
    "--config",
    default="configs/training/score_rcaustic.yaml",
    type=str,
...
if model_library == "pytorch":
    callbacks += []
##############################
#checkpoint_path = "/home/dinardo/g.degaetano/joint-diffusion/wandb/run-20241005_162459-2qkuoiex/files/training_checkpoints/ckpt-2"
